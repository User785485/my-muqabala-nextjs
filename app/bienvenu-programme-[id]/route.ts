...
export async function GET(
  ...
  console.log(`ud83dudd00 Redirection URL conviviale: /bienvenu-programme-${id} u2192 /api/documents/onboarding/${cleanId}.html`);
  
  // Rediriger vers l'API documents existante
  return NextResponse.redirect(
    `${request.nextUrl.origin}/api/documents/onboarding/${cleanId}.html`
  );
}
